...
const SodaLogo = ({height}) => {return <a href="#"><img src="images/dot_slash_white.png" style={{height: height, position: "relative", right: 15}}/></a>};
    ...
    render: function() {
        ...
        return (
            <div style={{width: this.props.width, backgroundColor: "#F6F3F4", id:"events"}}>
                ...
                <img src="images/asu_geometry_soda_white.jpg" style={{width: width, overflow: "hidden", height: this.props.height}}/>
            </div>);}
});
...
const ContactPage = ({width, height}) => {
    ...
    <div>
        ...
        <div style={{textAlign: "center", position: "relative", top: 50}} id="officers">
            ...
            <MembershipCard title="Community Development Director" name="Jacob Folson" email="jfolsom2@asu.edu"/>
